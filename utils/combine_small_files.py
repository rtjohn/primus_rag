import os
import math
from config import source_directory, target_directory, total_files, target_combined_files
...
# Configuration - saved in config.py for simplicity and loaded in
source_directory = source_directory
os.chdir(source_directory)  
target_directory = target_directory  # Target directory for the combined .txt files
total_files = total_files  # Total number of .txt files you have
target_combined_files = target_combined_files  # Desired number of combined .txt files
